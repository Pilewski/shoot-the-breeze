...
class MessageField extends React.Component {
  ...
  searchMessages(event) {
    ...
    this.setState({filteredMessages : filteredMessages, userInput: userInput});
  }
  toggleSort(order) {
    ...
    return (
      <div>
        <header>
          ...
          <SearchInput searchMessages= { this.searchMessages} />
          <Sort sort={this.toggleSort} />
        </header>
        {messageField}
      <Users messages={this.props.messages} filterByUser={this.filterByUser} />
      </div>
    )
  }
}
